            ...
            <div class="content-section">
                ...
                <div class="subtabs-container">
                    ...
                    <div class="subtab-content active" id="subtab-por-profesor">
                        ...
                        <div id="contenedorProfesores" class="cards-grid"></div>
                    ...
                    <div class="subtab-content" id="subtab-por-materia">
                        ...
                        <div id="contenedorMaterias" class="cards-grid"></div>
                    ...
                    <div class="subtab-content" id="subtab-por-grado">
                        ...
                        <div id="contenedorGrados" class="cards-grid"></div>
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <div id="vistaDetalleProfesor">
                    ...
                    {{-- ↓ ÚNICA MEJORA: table-modern en vez de table Bootstrap ↓ --}}
                    ...
                    <form id="formPreferenciasProfesor">
                        ...
                        <div class="alert alert-info" role="alert">
                            ...
                            <div class="ms-4">
                                ...
                                <p class="mb-0"><strong>Horas:</strong> <span id="prefHoras"></span></p>
                            </div>
                        </div>
                        <div class="separator"></div>
                        <h5 class="mb-3">
                        ...
                        <div class="form-row mt-3">
                            <div class="form-col">
                                ...
                                <input type="number" class="form-input" id="prefMaxHorasPorDia" min="1" max="8" placeholder="Sin límite">
                                <small class="form-text text-muted">INGRESAR EL MAXIMO DE HORAS POR DIA</small>
                            </div>
                            <div class="form-col">
                                ...
                                <input type="number" class="form-input" id="prefMaxDiasSemana" min="1" max="5" placeholder="Sin límite">
                                <small class="form-text text-muted">INGRESAR EL MAXIMO DE DÍAS POR SEMANA</small>
                            </div>
                        </div>
                    ...
                    <form id="formPreferenciasMateria">
                        ...
                        <div class="form-row mt-3">
                            <div class="form-col">
                                ...
                                <input type="number" class="form-input" id="prefMaxHorasPorDiaMateria" min="1" max="8" placeholder="Sin límite">
                            ...
                            <div class="form-col">
                                ...
                                <input type="number" class="form-input" id="prefMaxDiasSemanaMateria" min="1" max="5" placeholder="Sin límite">
                    ...
                    <form id="formPreferenciasGrado">
                        ...
                        <div class="form-row mt-3">
                            <div class="form-col">
                                ...
                                <input type="number" class="form-input" id="prefMaxHorasPorDiaGrado" min="1" max="8" placeholder="Sin límite">
                                <small class="form-text text-muted">Máximo de horas por día (1-8)</small>
                            </div>
                            <div class="form-col">
                                ...
                                <input type="number" class="form-input" id="prefMaxDiasSemanaGrado" min="1" max="5" placeholder="Sin límite">
                                <small class="form-text text-muted">Máximo de días por semana (1-5)</small>
                            </div>
                        </div>
                        <div class="alert alert-warning mt-4" role="alert">
...
<script>
    $(document).ready(function() {
        ...
        $('#buscarProfesor').on('input', function() {
            filtrarCards('.entity-card[data-tipo="profesor"]', $(this).val().toLowerCase());
        });
        $('#buscarMateria').on('input', function() {
            filtrarCards('.entity-card[data-tipo="materia"]', $(this).val().toLowerCase());
        });
        $('#buscarGrado').on('input', function() {
            filtrarCards('.entity-card[data-tipo="grado"]', $(this).val().toLowerCase());
        });

        function filtrarCards(selector, termino) {
            $(selector).each(function() {
                const nombre = $(this).data('nombre').toLowerCase();
                $(this).toggle(nombre.includes(termino));
            });
        }
        ...
        // ── Helpers de badge estado y botones acción ──────────────
        function badgeEstado(estado) {
            if (estado === 'completo') return '<span class="badge-estado badge-completo">Completo</span>';
            if (estado === 'parcial')  return '<span class="badge-estado badge-parcial">Parcial</span>';
            return '<span class="badge-estado badge-pendiente">Pendiente</span>';
        }

        function botonesAccion(id, tipo) {
            return `
                <div class="actions-group" style="justify-content:center;">
                    <button class="btn-icon btn-icon-blue"
                        onclick="abrirPreferencias(${id}, '${tipo}')" title="Preferencias">
                        <i class="fas fa-sliders-h"></i>
                    </button>
                    <button class="btn-icon btn-icon-amber"
                        onclick="editarAsignacion(${id}, '${tipo}')" title="Editar">
                        <i class="fas fa-edit"></i>
                    </button>
                    <button class="btn-icon btn-icon-red"
                        onclick="eliminarAsignacion(${id})" title="Eliminar">
                        <i class="fas fa-trash"></i>
                    </button>
                </div>`;
        }
        ...
        function renderizarPorProfesor() {
            ...
            asignacionesGlobales.forEach(asig => {
                ...
                if (!porProfesor[profId]) {
                    porProfesor[profId] = { id: profId, nombre: asig.profesor.name, asignaciones: [], totalHoras: 0, grados: new Set(), materias: new Set() };
                }
            ...
            if (profesores.length === 0) { contenedor.hide(); $('#sinDatosProfesores').show(); return; }
            $('#sinDatosProfesores').hide();
            profesores.forEach(prof => {
                const completas = prof.asignaciones.filter(a => a.estado === 'completo').length;
                const porcentaje = prof.asignaciones.length > 0 ? Math.round((completas / prof.asignaciones.length) * 100) : 0;
                let badgeClass = 'badge-pending', badgeText = 'Incompleto';
                if (porcentaje === 100) { badgeClass = 'badge-complete'; badgeText = 'Completo'; }
                else if (porcentaje > 0) { badgeClass = 'badge-partial'; badgeText = 'Parcial'; }
                contenedor.append(`
                    <div class="entity-card" data-tipo="profesor" data-nombre="${prof.nombre}" data-id="${prof.id}">
                        <div class="entity-card-header">
                            <div class="entity-icon"><i class="fas fa-user-tie"></i></div>
                        ...
                        <div class="entity-stats">
                            <div class="entity-stat"><div class="entity-stat-value">${prof.totalHoras}</div><div class="entity-stat-label">Horas/Semana</div></div>
                            <div class="entity-stat"><div class="entity-stat-value">${prof.grados.size}</div><div class="entity-stat-label">Grados</div></div>
                        </div>
                        <div class="entity-footer">
                            <span class="entity-badge ${badgeClass}"><i class="fas fa-circle"></i> ${badgeText}</span>
                            <span class="entity-action">Ver detalle <i class="fas fa-arrow-right"></i></span>
                        </div>
                    </div>`);
            });
            $('.entity-card[data-tipo="profesor"]').on('click', function() {
                mostrarDetalleProfesor($(this).data('id'));
            });
        }
        ...
        function renderizarPorMateria() {
            ...
            asignacionesGlobales.forEach(asig => {
                ...
                if (!porMateria[matId]) {
                    porMateria[matId] = { id: matId, nombre: asig.asignatura.nombre, asignaciones: [], totalHoras: 0, profesores: new Set(), grados: new Set() };
                }
            ...
            if (materias.length === 0) { contenedor.hide(); $('#sinDatosMaterias').show(); return; }
            $('#sinDatosMaterias').hide();
            materias.forEach(mat => {
                const completas = mat.asignaciones.filter(a => a.estado === 'completo').length;
                const porcentaje = mat.asignaciones.length > 0 ? Math.round((completas / mat.asignaciones.length) * 100) : 0;
                let badgeClass = 'badge-pending', badgeText = 'Incompleto';
                if (porcentaje === 100) { badgeClass = 'badge-complete'; badgeText = 'Completo'; }
                else if (porcentaje > 0) { badgeClass = 'badge-partial'; badgeText = 'Parcial'; }
                contenedor.append(`
                    <div class="entity-card" data-tipo="materia" data-nombre="${mat.nombre}" data-id="${mat.id}">
                        <div class="entity-card-header">
                            <div class="entity-icon"><i class="fas fa-book-open"></i></div>
                            <div class="entity-title">
                        ...
                        <div class="entity-stats">
                            <div class="entity-stat"><div class="entity-stat-value">${mat.profesores.size}</div><div class="entity-stat-label">Profesores</div></div>
                            <div class="entity-stat"><div class="entity-stat-value">${mat.grados.size}</div><div class="entity-stat-label">Grados</div></div>
                        </div>
                        <div class="entity-footer">
                            <span class="entity-badge ${badgeClass}"><i class="fas fa-circle"></i> ${badgeText}</span>
                            <span class="entity-action">Ver detalle <i class="fas fa-arrow-right"></i></span>
            ...
            $('.entity-card[data-tipo="materia"]').on('click', function() {
                mostrarDetalleMateria($(this).data('id'));
            });
        }
        ...
        function renderizarPorGrado() {
            ...
            asignacionesGlobales.forEach(asig => {
                ...
                if (!porGrado[gradoId]) {
                    porGrado[gradoId] = { id: gradoId, nombre: asig.grado.nombre, nivel: asig.grado.nivel.nombre, asignaciones: [], totalHoras: 0, profesores: new Set(), materias: new Set() };
                }
            ...
            if (grados.length === 0) { contenedor.hide(); $('#sinDatosGrados').show(); return; }
            $('#sinDatosGrados').hide();
            grados.forEach(grado => {
                const completas = grado.asignaciones.filter(a => a.estado === 'completo').length;
                const porcentaje = grado.asignaciones.length > 0 ? Math.round((completas / grado.asignaciones.length) * 100) : 0;
                let badgeClass = 'badge-pending', badgeText = 'Incompleto';
                if (porcentaje === 100) { badgeClass = 'badge-complete'; badgeText = 'Completo'; }
                else if (porcentaje > 0) { badgeClass = 'badge-partial'; badgeText = 'Parcial'; }
                contenedor.append(`
                    <div class="entity-card" data-tipo="grado" data-nombre="${grado.nombre}" data-id="${grado.id}">
                        <div class="entity-card-header">
                            <div class="entity-icon"><i class="fas fa-graduation-cap"></i></div>
                            <div class="entity-title">
                        ...
                        <div class="entity-stats">
                            <div class="entity-stat"><div class="entity-stat-value">${grado.materias.size}</div><div class="entity-stat-label">Materias</div></div>
                            <div class="entity-stat"><div class="entity-stat-value">${grado.totalHoras}</div><div class="entity-stat-label">Horas/Semana</div></div>
                        </div>
                        <div class="entity-footer">
                            <span class="entity-badge ${badgeClass}"><i class="fas fa-circle"></i> ${badgeText}</span>
                            <span class="entity-action">Ver detalle <i class="fas fa-arrow-right"></i></span>
            ...
            $('.entity-card[data-tipo="grado"]').on('click', function() {
                mostrarDetalleGrado($(this).data('id'));
            });
        }
        ...
        function mostrarDetalleProfesor(profesorId) {
            ...
            $('#tituloModalProfesor').text(asignaciones[0].profesor.name);
            $('#modalProfesorAsignaciones').text(asignaciones.length);
            $('#modalProfesorHoras').text(totalHoras);
            $('#modalProfesorGrados').text(new Set(asignaciones.map(a => a.grado_id)).size);
            $('#modalProfesorMaterias').text(new Set(asignaciones.map(a => a.asignatura_id)).size);
                ...
                tbody.append(`
                    <tr>
                        <td><div class="cell-with-icon">
                            <div class="cell-icon"><i class="fas fa-book"></i></div>
                            <div><span class="cell-title">${asig.asignatura.nombre}</span></div>
                        </div></td>
                        <td><span class="cell-title">${asig.grado.nombre}</span></td>
                        ...
                        <td class="text-center">${badgeEstado(asig.estado)}</td>
                        <td class="text-center">${botonesAccion(asig.id, 'profesor')}</td>
                    </tr>`);
            });
            $('#vistaDetalleProfesor').show();
            $('#vistaEdicionProfesor, #vistaPreferenciasProfesor').hide();
            $('#botonesDetalleProfesor').show();
            $('#botonesEdicionProfesor, #botonesPreferenciasProfesor').hide();
        ...
        function mostrarDetalleMateria(materiaId) {
            ...
            if (asignaciones.length === 0) return;
            const totalHoras = asignaciones.reduce((sum, a) => sum + a.horas_semanales, 0);
            $('#tituloModalMateria').text(asignaciones[0].asignatura.nombre);
            $('#modalMateriaAsignaciones').text(asignaciones.length);
            $('#modalMateriaProfesores').text(new Set(asignaciones.map(a => a.profesor_id)).size);
            $('#modalMateriaGrados').text(new Set(asignaciones.map(a => a.grado_id)).size);
                ...
                tbody.append(`
                    <tr>
                        <td><div class="cell-with-icon">
                            ...
                            <div><span class="cell-title">${asig.profesor.name}</span></div>
                        </div></td>
                        <td><span class="cell-title">${asig.grado.nombre}</span></td>
                        <td class="text-center"><strong>${asig.horas_semanales}</strong></td>
                        <td class="text-center"><strong>${asig.horas_asignadas_count || 0}</strong></td>
                        <td class="text-center">${badgeEstado(asig.estado)}</td>
                        <td class="text-center">${botonesAccion(asig.id, 'materia')}</td>
                    </tr>`);
            });
            $('#vistaDetalleMateria').show();
            $('#vistaEdicionMateria, #vistaPreferenciasMateria').hide();
            $('#botonesDetalleMateria').show();
            $('#botonesEdicionMateria, #botonesPreferenciasMateria').hide();
        ...
        function mostrarDetalleGrado(gradoId) {
            ...
            if (asignaciones.length === 0) return;
            const totalHoras = asignaciones.reduce((sum, a) => sum + a.horas_semanales, 0);
            $('#tituloModalGrado').text(asignaciones[0].grado.nombre + ' - ' + asignaciones[0].grado.nivel.nombre);
            $('#modalGradoAsignaciones').text(asignaciones.length);
            $('#modalGradoMaterias').text(new Set(asignaciones.map(a => a.asignatura_id)).size);
            $('#modalGradoProfesores').text(new Set(asignaciones.map(a => a.profesor_id)).size);
            ...
            asignaciones.forEach(asig => {
                tbody.append(`
                    <tr>
                        ...
                        <td><span class="cell-title">${asig.profesor.name}</span></td>
                        <td class="text-center"><strong>${asig.horas_semanales}</strong></td>
                        <td class="text-center"><strong>${asig.horas_asignadas_count || 0}</strong></td>
                        <td class="text-center">${badgeEstado(asig.estado)}</td>
                        <td class="text-center">${botonesAccion(asig.id, 'grado')}</td>
                    </tr>`);
            });
            $('#vistaDetalleGrado').show();
            $('#vistaEdicionGrado, #vistaPreferenciasGrado').hide();
            $('#botonesDetalleGrado').show();
            $('#botonesEdicionGrado, #botonesPreferenciasGrado').hide();
        ...
        window.abrirPreferencias = function(id, tipo) {
            ...
            if (tipo === 'profesor') {
                ...
                $('#prefHoras').text(asignacion.horas_semanales + ' horas');
                ...
                $('#vistaDetalleProfesor, #vistaEdicionProfesor').hide();
                $('#vistaPreferenciasProfesor').show();
                $('#botonesDetalleProfesor, #botonesEdicionProfesor').hide();
                ...
                $('#vistaDetalleMateria, #vistaEdicionMateria').hide();
                $('#vistaPreferenciasMateria').show();
                $('#botonesDetalleMateria, #botonesEdicionMateria').hide();
                ...
                $('#vistaDetalleGrado, #vistaEdicionGrado').hide();
                $('#vistaPreferenciasGrado').show();
                $('#botonesDetalleGrado, #botonesEdicionGrado').hide();
        ...
        window.editarAsignacion = function(id, tipo) {
            ...
            if (tipo === 'profesor') {
                ...
                $('#vistaDetalleProfesor, #vistaPreferenciasProfesor').hide();
                $('#vistaEdicionProfesor').show();
                $('#botonesDetalleProfesor, #botonesPreferenciasProfesor').hide();
                ...
                $('#vistaDetalleMateria, #vistaPreferenciasMateria').hide();
                $('#vistaEdicionMateria').show();
                $('#botonesDetalleMateria, #botonesPreferenciasMateria').hide();
                ...
                $('#vistaDetalleGrado, #vistaPreferenciasGrado').hide();
                $('#vistaEdicionGrado').show();
                $('#botonesDetalleGrado, #botonesPreferenciasGrado').hide();
        ...
        window.guardarEdicion = function(tipo) {
            let id, horas;
            if (tipo === 'profesor')     { id = $('#editId').val();       horas = $('#editHoras').val(); }
            else if (tipo === 'materia') { id = $('#editIdMateria').val(); horas = $('#editHorasMateria').val(); }
            else if (tipo === 'grado')   { id = $('#editIdGrado').val();   horas = $('#editHorasGrado').val(); }
            const asignacion = asignacionesGlobales.find(a => a.id == id);
            $.ajax({
                url: `/asignaciones/${id}`,
                method: 'PUT',
                ...
                success: function(response) {
                    if (response.success) {
                        ...
                        cargarDatosConsulta();
                    } else { mostrarError(response.message); }
                },
                error: function() { mostrarError('Error al actualizar la asignación'); }
            });
        };
        ...
        window.guardarPreferencias = function(tipo) {
            ...
            if (tipo === 'profesor') {
                id = $('#prefId').val(); posicionJornada = $('#prefPosicionJornada').val();
                maxHorasPorDia = $('#prefMaxHorasPorDia').val(); maxDiasSemana = $('#prefMaxDiasSemana').val();
            } else if (tipo === 'materia') {
                id = $('#prefIdMateria').val(); posicionJornada = $('#prefPosicionJornadaMateria').val();
                maxHorasPorDia = $('#prefMaxHorasPorDiaMateria').val(); maxDiasSemana = $('#prefMaxDiasSemanaMateria').val();
            } else if (tipo === 'grado') {
                id = $('#prefIdGrado').val(); posicionJornada = $('#prefPosicionJornadaGrado').val();
                maxHorasPorDia = $('#prefMaxHorasPorDiaGrado').val(); maxDiasSemana = $('#prefMaxDiasSemanaGrado').val();
            }
            const asignacion = asignacionesGlobales.find(a => a.id == id);
            $.ajax({
                url: `/asignaciones/${id}`,
                ...
                error: function() { mostrarError('Error al actualizar las preferencias'); }
            });
        };
            ...
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    $.ajax({
                        ...
                        error: function() { mostrarError('Error al eliminar la asignación'); }
                    });
                }
            });
        };
        ...
        function cargarGrados(nivelId, targetSelect) {
            ...
            if (!nivelId) { $select.html('<option value="">Todos los grados</option>'); return; }
        ...
        function mostrarExito(mensaje) {
            Swal.fire({ icon: 'success', title: 'Éxito', text: mensaje, confirmButtonColor: '#28a745' });
        }
        function mostrarError(mensaje) {
            Swal.fire({ icon: 'error', title: 'Error', text: mensaje, confirmButtonColor: '#dc3545' });
        }
        function mostrarAdvertencia(mensaje) {
            Swal.fire({ icon: 'warning', title: 'Atención', text: mensaje, confirmButtonColor: '#ffc107' });
        }
    });
</script>
@endsection

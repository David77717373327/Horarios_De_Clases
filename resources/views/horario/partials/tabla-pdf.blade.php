@php
    ...
    if (!function_exists('calcularHora')) {
        function calcularHora($horaNumero, $config) {
...
<table>
    ...
    <tbody>
        @foreach($horas as $hora)
            <tr>
                <td class="hora-cell">{{ calcularHora($hora, $configuracion) }}</td>
                ...
                @foreach($dias as $dia)
                    ...
                    @if($celda)
                        <td>
                            ...
                            <span class="grado-info">{{ $celda->profesor->name }}</span>
                        </td>
                    @else
                        <td class="empty-cell">
